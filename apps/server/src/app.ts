...
import type { GameSnapshot, ClientToServerEvents, ServerToClientEvents, InterServerEvents, SocketData } from '@bc/core';

// In-memory session store; a simple Map is sufficient for this scaffold.
export type Session = GameSnapshot;
